...
@Autonomous(name="StrafeTester6", group="experiments")
@Disabled

public class StrafeTester6 extends LinearOpMode {
    ...
    public void initialize() {
        ...
        initializationMenu.add(new MenuItem(0.01, "lambda",0.1,0.0,0.01));
        ...
        robot.setLambda(initializationMenu.get(2));
    ...
    public void runOpMode() {
        ...
        telemetry.update();
        robot.autoStrafe6(strafePower, inchesToTicks(strafeDistance));
