...
@TeleOp(name="Robot Parking Aligner", group ="Experiments")
public class RobotAligner extends LinearOpMode {
    ...
    public void runOpMode()  {
        ...
        final float CAMERA_FORWARD_DISPLACEMENT  = -6.5f * mmPerInch;
        final float CAMERA_VERTICAL_DISPLACEMENT = 13f * mmPerInch;
        final float CAMERA_LEFT_DISPLACEMENT     = 0.0f * mmPerInch;

        OpenGLMatrix cameraLocationOnRobot = OpenGLMatrix
                .translation(CAMERA_FORWARD_DISPLACEMENT, CAMERA_LEFT_DISPLACEMENT, CAMERA_VERTICAL_DISPLACEMENT)
                .multiplied(Orientation.getRotationMatrix(EXTRINSIC, XZY, DEGREES, 135, 90, 0));
